...
import com.example.msblog.config.oauth2.OAuth2AuthorizationRequestBasedOnCookieRepository;
import com.example.msblog.config.oauth2.OAuth2SuccessHandler;
...
public class WebOAuthSecurityConfig {
    ...
    public WebSecurityCustomizer configure() {          // 스프링 시큐리티 기능 비활성화
        return (web) -> web.ignoring()
                ...
                .requestMatchers("/static/img/img/**", "/css/**", "/js/**");
    }
